...
class Modal extends React.Component {
  render() {
    ...
    let close = <div className="close" onClick={() => {this.props.onCloseArticle()}}>CLOSE</div>
    ...
    return (
      ...
      <div id="modal" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="arkea" className={`${this.props.article === 'arkea' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
